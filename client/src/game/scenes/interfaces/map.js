...
export class MapScene extends BaseScene {
    ...
    createContent() {
		...
		map_dojo_location_normal_hovered.on("pointerdown", () => {
			sendJoinRoomPacket(SCENE_ROOM_DOJO_COURTYARD);
		});
