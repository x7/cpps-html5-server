...
export class InterfaceScene extends BaseScene {
    ...
    createContent() {
		...
		const interface_main_interface_bar_png = this.add.image(662, 685, "interface", "interface_main_interface_bar.png");
		interface_main_interface_bar_png.scaleX = 0.7852309033537853;
		interface_main_interface_bar_png.scaleY = 0.996612717977732;

		// interface_main_interface_button0001_png
		const interface_main_interface_button0001_png = this.add.image(267, 690, "interface", "interface_main_interface_button0001.png");
		...
		const interface_chat00010001_png = this.add.image(656, 690, "interface", "interface_chat00010001.png");
