...
export const SCENE_ROOM_PIRATE_SHIP = "PirateShipScene";
...
export const SCENE_ROOM_SCHOOL =  "SchoolScene";
export const SCENE_ROOM_AGENT_LOBBY = "AgentLobbyScene";
export const SCENE_ROOM_CAVE = "CaveScene";
